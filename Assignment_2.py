...
st.write('## "This dashboard allows instructors to visually monitor student performance across multiple metrics and attributes" ')
# streamlit expander, useful if mor info is wanted about something but
# you dont want to clutter the page up
st.write("### Note: You can see student performance across attributes by selecting an attribute from the left sidebar, reading more information about the dataset, and viewing examples using the buttons below:")
